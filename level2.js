...
function changeDirection(e) {
    if ((e.code == "KeyW" || e.code == "ArrowUp") && speedY != 1) {
        speedX = 0;
        speedY = -1;
    } else if ((e.code == "KeyS" || e.code == "ArrowDown") && speedY != -1) {
        speedX = 0;
        speedY = 1;
    } else if ((e.code == "KeyA" || e.code == "ArrowLeft") && speedX != 1) {
        speedX = -1;
        speedY = 0;
    } else if ((e.code == "KeyD" || e.code == "ArrowRight") && speedX != -1) {
        speedX = 1;
        speedY = 0;
    }
}
